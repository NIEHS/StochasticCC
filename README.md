...
# Demo (Static communication using a two-sample stochastic ordering framework)
In the following, we demonstrate how the StochasticCC is used to identify cell-cell communication at a given time point using a two-sample stochastic ordering statistic.
...
### Plot simplex for T1,T2,T3 ordering for Ligand-recpeptor pair `Adam12^Itga9`
